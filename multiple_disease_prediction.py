...
parkinson_disease_model = pickle.load(open("./saved_models/parkinsons_model.sav", "rb"))
...
if (selected == 'Diabetes Prediction'):
    ...
    if st.button('Diabetes Test Result'):
        diagnosis = diabetes_model.predict([Pregnancies, Glucose, BloodPressure, SkinThickness, Insulin, BMIValue, DiabetesPedigreeFunction, Age])
